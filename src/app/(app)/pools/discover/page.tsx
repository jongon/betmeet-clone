  ...
  return (
    <main className="mx-auto max-w-4xl space-y-6 px-4 py-8">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-sm font-medium text-primary">{dictionary.pools.directory}</p>
          <h1 className="text-3xl font-semibold tracking-tight">{dictionary.pools.publicPools}</h1>
          <p className="text-muted-foreground">{dictionary.pools.directoryDescription}</p>
        </div>
