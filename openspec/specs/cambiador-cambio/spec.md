...
Definir la entrada publica por QR para cambiadores en `/cambio/[token]`, incluyendo validacion de token, resolucion automatica de sesion, creacion por nombre, identidad persistente y manejo de errores recuperables.
