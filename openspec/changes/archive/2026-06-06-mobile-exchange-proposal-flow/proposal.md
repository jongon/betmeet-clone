...
- Crear un flujo mobile-first de 3 pasos para que el cambiador arme una propuesta de intercambio despues de entrar a su sesion (seleccionando cromos y editando contraofertas de forma inline).
- Mostrar primero los cromos que el coleccionista quiere recibir y permitir al cambiador seleccionar solo unidades individuales que puede ofrecer, editando contraofertas inline con un panel colapsable.
...
- Sincronizar automaticamente los cromos exactos opcionales validos con el paso 2, marcandolos como repetidos solicitados no editables mientras sigan referenciados por una contraoferta activa, mostrando una notificacion visual al usuario.
...
### New Capabilities
- `cambiador-propuesta-cambio`: Wizard mobile de 3 pasos para seleccionar cromos solicitados por el coleccionista viendo la regla en la misma pantalla, decidir si cumplir o contraofertar inline, seleccionar en el paso 2 lo que el cambiador quiere recibir desde repetidos reales (con sincronizacion de exactos), y enviar la propuesta para aprobacion.
