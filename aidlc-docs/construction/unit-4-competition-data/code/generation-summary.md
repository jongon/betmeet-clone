...
- Added idempotent seed script `pnpm prisma:seed:competition`, reproducible flag download script `pnpm sync:flags`, and local flag validation script `pnpm check:flags`.
...
## Commands
- `pnpm prisma:seed:competition`: seed/update competition data after migrations.
